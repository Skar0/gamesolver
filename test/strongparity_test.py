...
def figure56():
    ...
    removed = [False]+([False]*len(fig56_graph.nodes))
...
def example_5():
    ...
    #print("hello "+str(gp.generalized_parity_solver(g)))
    gbis = io.load_generalized_from_file("assets/generalized parity/double_priority.txt")
    print("hello +++ "+str(gp.generalized_parity_solver(gbis)))
...
def launch_tests():
    ...
    return recursive and reduction_to_safety and antichain_based
